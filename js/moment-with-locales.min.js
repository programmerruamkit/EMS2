! function (e, a) {
    ...
    function Wa(e) {
        ...
        this._isValid = function (e) {
            var a, t, s = !1;
            for (a in e)
                if (h(e, a) && (-1 === ye.call(Pa, a) || null != e[a] && isNaN(e[a]))) return !1;
    ...
    yt.add = Za, yt.calendar = function (e, a) {
        ...
        for (var e, a, t = this.localeData().eras(), s = 0, n = t.length; s < n; ++s)
            if (e = t[s].since <= t[s].until ? 1 : -1, a = this.startOf("day").valueOf(), t[s].since <= a && a <= t[s].until || t[s].until <= a && a <= t[s].since) return (this.year() - M(t[s].since).year()) * e + t[s].offset;
        return this.year()
    ...
    function Qt() {
        ...
        var e, a, t, s, n, r, d, _, i = Zt(this._milliseconds) / 1e3,
            o = Zt(this._days),
            m = Zt(this._months),
            u = this.asSeconds();
