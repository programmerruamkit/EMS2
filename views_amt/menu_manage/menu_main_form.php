...
<head>
  <script type="text/javascript">
    function save_data() {
      ...
      var url = "<?=$path?>views_amt/menu_manage/menu_main_proc.php";
      $.ajax({
        type: "POST",
        url: url,
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default">
                      <tbody>
                        ...
                        <tr align="center" height="25px">
                          ...
                          <td align="left" class="bg-white">
                            ...
                            <label class="container">
                              <input type="radio" name="area" id="area" value="AMT" <?php if($result_edit_menu["MN_AREA"]=="AMT"){echo "checked";}?>>
                              <span class="checkmark">AMT</span>
                            </label>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <label class="container">
                              <input type="radio" name="area" id="area" value="GW" <?php if($result_edit_menu["MN_AREA"]=="GW"){echo "checked";}?>>
                        ...
                        <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <select class="time" onFocus="$(this).select();" style="width: 100%;" name="MN_STATUS"
                                id="MN_STATUS" required>
