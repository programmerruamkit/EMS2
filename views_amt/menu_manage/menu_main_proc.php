<?php
	...
	if($proc=="add"){
		...
		$sql = "INSERT INTO MENU (MN_CODE, MN_NAME, MN_LEVEL, MN_SORT, MN_AREA, MN_PARENT, MN_ICON, MN_URL, MN_STATUS, MN_CREATEBY, MN_CREATEDATE) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		$params = array($MN_CODE, $MN_NAME, $MN_LEVEL, $MN_SORT, $MN_AREA, $MN_PARENT, $MN_ICON, $MN_URL, $MN_STATUS, $MN_CREATEBY, $MN_CREATEDATE);
	...
	if($proc=="edit"){
		...
		$sql = "UPDATE MENU SET 
					...
					MN_EDITDATE = ?
					WHERE MN_ID = ? ";
		$params = array($MN_NAME, $MN_LEVEL, $MN_SORT, $MN_AREA, $MN_PARENT, $MN_ICON, $MN_URL, $MN_STATUS, $MN_EDITBY, $MN_EDITDATE, $MN_ID);
