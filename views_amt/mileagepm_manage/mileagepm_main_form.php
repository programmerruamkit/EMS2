<?php
	...
	if($proc=="edit"){
		...
		$result_edit_mileagepm = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC);
    $MLPM_CODE=$result_edit_mileagepm["MLPM_CODE"];
	};
	if($proc=="add"){
		...
		$result_add_mileagepm = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC);
    $MLPM_ID=$result_add_mileagepm["MLPM_ID"];
      ...
      $.ajax({
        ...
        success: function (data) {
          Swal.fire({
            ...
            if(buttonname=='add'){
              log_transac_mileagepm('LA17', '-', '<?=$rand;?>');
            }else{
              log_transac_mileagepm('LA18', '<?=$result_edit_mileagepm["MLPM_NAME"];?>', '<?=$result_edit_mileagepm["MLPM_CODE"];?>');
            }
                      ...
                      <tbody>
                        <tr align="center" id="22" height="25px">
                          ...
                          <td width="70%" height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" name="MLPM_NAME" id="MLPM_NAME" class="time" onFocus="$(this).select();" value="<?=$result_edit_mileagepm["MLPM_NAME"];?>" required>
                            </div>
                          </td>
                        </tr>
                        <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" class="time" name="MLPM_MILEAGE_10K1M" id="MLPM_MILEAGE_10K1M" value="<?=$result_edit_mileagepm["MLPM_MILEAGE_10K1M"];?>" required />
                            </div>
                          </td>
                        </tr>
                        <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" class="time" name="MLPM_MILEAGE_1M2M" id="MLPM_MILEAGE_1M2M" value="<?=$result_edit_mileagepm["MLPM_MILEAGE_1M2M"];?>" required />
                            </div>
                          </td>
                        </tr>
                        <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" class="time" name="MLPM_MILEAGE_2M3M" id="MLPM_MILEAGE_2M3M" value="<?=$result_edit_mileagepm["MLPM_MILEAGE_2M3M"];?>" required />
                            </div>
                          </td>
                        </tr>
                        <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" class="time" name="MLPM_LINEOFWORK" id="MLPM_LINEOFWORK" value="<?=$result_edit_mileagepm["MLPM_LINEOFWORK"];?>" required />
                            </div>
                          </td>
                        </tr>
                        <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" class="time" name="MLPM_REMARK" id="MLPM_REMARK" value="<?=$result_edit_mileagepm["MLPM_REMARK"];?>" required />
                            </div>
                          </td>
                        </tr>
                        <!-- <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <select class="time" onFocus="$(this).select();" style="width: 100%;" name="MLPM_STATUS" id="MLPM_STATUS" required>
                                ...
                                <option value="Y" <?php if($result_edit_mileagepm['MLPM_STATUS']== "Y"){echo "selected";} ?>>เปิดใช้งาน
                                </option>
                                <option value="N" <?php if($result_edit_mileagepm['MLPM_STATUS']== "N"){echo "selected";} ?>>ปิดใช้งาน
                                </option>
                              </select>
                            </div>
                          </td>
                        ...
                        <input type="hidden" name="MLPM_ID" id="MLPM_ID" value="<?=$result_edit_mileagepm['MLPM_ID'];?>" />
                        <input type="hidden" name="proc" id="proc" value="<?=$proc;?>" />
                        <input type="hidden" name="mlpm_id" id="mlpm_id" value="<?=$mlpm_id; ?>">      
                        <tr align="center" height="25px">
                          <td height="35" colspan="2" align="center">
                            <?php if($proc=="edit"){ ?>
                              <input type="hidden" name="mlpm_code" id="mlpm_code" value="<?=$result_edit_mileagepm['MLPM_CODE'];?>">
