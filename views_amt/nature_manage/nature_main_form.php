...
<head>
  <script type="text/javascript">
    function save_data() {
      ...
      var url = "<?=$path?>views_amt/nature_manage/nature_main_proc.php";
      $.ajax({
        type: "POST",
        url: url,
        ...
        success: function (data) {
          Swal.fire({
            ...
            if(buttonname=='add'){
              log_transac_nature('LA17', '-', '<?=$rand;?>');
            }else{
              log_transac_nature('LA18', '<?=$result_edit_nature["NTRP_NAME"];?>', '<?=$result_edit_nature["NTRP_CODE"];?>');
            }
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default">
                      <tbody>
                        <tr align="center" id="22" height="25px">
                          <td width="30%" height="35" align="right" class="ui-state-default"><strong>ชื่อลักษณะงานซ่อม :</strong></td>
                          <td width="70%" height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" name="NTRP_NAME" id="NTRP_NAME" class="time" onFocus="$(this).select();" value="<?=$result_edit_nature["NTRP_NAME"];?>" required autocomplete="off">
                            </div>
                          </td>
                        </tr>
                        <tr align="center" height="25px">
                          ...
                          <td height="35" align="left" class="bg-white">
                            <div class="input-control text">
                              <input type="text" class="time" name="NTRP_REMARK" id="NTRP_REMARK" value="<?=$result_edit_nature["NTRP_REMARK"];?>" onFocus="$(this).select();" required  autocomplete="off">
                            </div>
                          </td>
                        </tr>
                        <tr align="center" height="25px">
