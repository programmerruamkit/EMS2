    ...
    <td class="CENTER" align="center">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="INVENDATA no-border" style="padding:3px;">
        ...
        <tr height="40">
          <td align="right" class="bg-white">
            <div class="input-control text" style="width:500px;"  class="ui-state-default">
              <strong>&nbsp;&nbsp;วันที่ใบแจ้งซ่อม :</strong>
          ...
          <td class="bg-white">
            <div class="input-control text" style="width:100%;">
              ...
              <label class="container">
                ...
                <input type="radio" name="TYPECUSTOMERS" id="TYPECUSTOMERS" value="cusout" style="cursor:pointer" class="radioexam" <?php if($result_edit_repairrequest['RPRQ_TYPECUSTOMER']== "cusout"){echo "checked";} ?>>
                <span class="checkmark" style="cursor:pointer">ลูกค้านอก</span>
              </label>
              <label class="container">
                <input type="radio" name="TYPECUSTOMERS" id="TYPECUSTOMERS" value="cusin" style="cursor:pointer" class="radioexam" <?php if($result_edit_repairrequest['RPRQ_TYPECUSTOMER']== "cusin"){echo "checked";} if($proc=="add"){echo "checked";} ?>>
        ...
        <tr height="40">
          <td class="bg-white">
            <div class="input-control text" style="width:100%;">
              <strong>&nbsp;&nbsp;วันที่นำรถเข้าซ่อม :</strong>
          		<input type="text" name="dateRequest_in" id="dateRequest_in" placeholder="วันที่" style="width:150px;" class="char" value="<?php echo $result_edit_repairrequest["RPRQ_REQUESTCARDATE"];?>" autocomplete="off" >
              <input type="text" name="timeRequest_in" id="timeRequest_in" list="avail" style="width:80px;" placeholder="เวลา" class="char" value="<?php echo $result_edit_repairrequest["RPRQ_REQUESTCARTIME"];?>" autocomplete="off" >
                <datalist id="avail">
                  <option value="00:00">
                  <option value="01:00">
                  <option value="02:00">
              ...
              <input type="text" name="timeRequest_out" id="timeRequest_out" list="avail" style="width:80px;" placeholder="เวลา" class="char" value="<?php echo $result_edit_repairrequest["RPRQ_USECARTIME"];?>" autocomplete="off" >
                <datalist id="avail">
                  <option value="00:00">
                  <option value="01:00">
                  <option value="02:00">
