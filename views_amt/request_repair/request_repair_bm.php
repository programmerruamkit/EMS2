                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default hover pointer display" id="datatable1"><!-- default hover pointer display hover pointer -->
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql_rprq_sonday = "SELECT * FROM vwREPAIRREQUEST WHERE RPRQ_AREA = '$SESSION_AREA'  AND RPRQ_WORKTYPE = 'BM' AND RPRQ_REQUESTCARDATE = '$D1'";
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default hover pointer display" id="datatable2">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql_rprq_monday = "SELECT * FROM vwREPAIRREQUEST WHERE RPRQ_AREA = '$SESSION_AREA'  AND RPRQ_WORKTYPE = 'BM' AND RPRQ_REQUESTCARDATE = '$D2'";
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default hover pointer display" id="datatable3">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql_rprq_tuesday = "SELECT * FROM vwREPAIRREQUEST WHERE RPRQ_AREA = '$SESSION_AREA'  AND RPRQ_WORKTYPE = 'BM' AND RPRQ_REQUESTCARDATE = '$D3'";
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default hover pointer display" id="datatable4">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql_rprq_wednesday = "SELECT * FROM vwREPAIRREQUEST WHERE RPRQ_AREA = '$SESSION_AREA'  AND RPRQ_WORKTYPE = 'BM' AND RPRQ_REQUESTCARDATE = '$D4'";
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default hover pointer display" id="datatable5">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql_rprq_thursday = "SELECT * FROM vwREPAIRREQUEST WHERE RPRQ_AREA = '$SESSION_AREA'  AND RPRQ_WORKTYPE = 'BM' AND RPRQ_REQUESTCARDATE = '$D5'";
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default hover pointer display" id="datatable6">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql_rprq_friday = "SELECT * FROM vwREPAIRREQUEST WHERE RPRQ_AREA = '$SESSION_AREA'  AND RPRQ_WORKTYPE = 'BM' AND RPRQ_REQUESTCARDATE = '$D6'";
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="default hover pointer display" id="datatable7">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql_rprq_saturday = "SELECT * FROM vwREPAIRREQUEST WHERE RPRQ_AREA = '$SESSION_AREA'  AND RPRQ_WORKTYPE = 'BM' AND RPRQ_REQUESTCARDATE = '$D7'";
