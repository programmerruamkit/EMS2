        ...
        <tbody>    
          <tr align="center" height="25px">
            <td height="35" colspan="2" align="center">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <button class="bg-color-yellow font-black" type="button" onclick="javascript:ajaxPopup4('<?=$path?>views_amt/request_repair/request_repair_bm_form.php','edit','<?php print $RPRQ_CODE; ?>','1=1','1350','670','แก้ไขใบแจ้งซ่อม');"><b>ย้อนกลับ</b></button>
            </td>
          </tr>
        </tbody>
      </table>   
