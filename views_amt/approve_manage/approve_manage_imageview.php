        ...
        <tbody>    
          <tr align="center" height="25px">
            <td height="35" colspan="2" align="center">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <button class="bg-color-yellow font-black" type="button" onclick="javascript:ajaxPopup4('<?=$path?>views_amt/approve_manage/approve_manage_image.php','edit','<?=$RPRQ_CODE?>&subject=<?=$SUBJECT;?>&prpqid=<?=$RPRQ_ID?>','1=1','800','200','รูปภาพจากใบแจ้งซ่อมหมายเลข <?=$RPRQ_ID?>');"><b>ย้อนกลับ</b></button>
            </td>
          </tr>
        </tbody>
      </table>   
