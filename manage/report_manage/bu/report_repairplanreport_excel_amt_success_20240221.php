<!-- ก่อนเปลี่ยนรูปแบบวันที่ใน ACTUALS1/ACTUALS2 [ > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 00:00',103)) ]-->
...
$strExcelFileName = "แผนการทำงาน.xls";
        ...
        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
            <div id="datadef">
                <!-- <table class="border"  border="1">
                    <thead>
                        <tr>
                            <th class="border" width="100px" colspan="3" style="text-align: center;">&nbsp;</th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px">READY</font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px">LEAVE</font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px">TRAINING</font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px">LICENSE</font></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php                                                                                    
                            $sql_rpms1 = "SELECT DISTINCT 
                            (SELECT SUM(ISNULL(CAST(total AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(3,5) AND area = '$AREA' AND total >= '0') AS s1_total,
                            (SELECT SUM(ISNULL(CAST(ready AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(3,5) AND area = '$AREA' AND ready >= '0') AS s1_ready,
                            (SELECT SUM(ISNULL(CAST(leave AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(3,5) AND area = '$AREA' AND leave >= '0') AS s1_leave,
                            (SELECT SUM(ISNULL(CAST(training AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(3,5) AND area = '$AREA' AND training >= '0') AS s1_training,
                            (SELECT SUM(ISNULL(CAST(license AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(3,5) AND area = '$AREA' AND license >= '0') AS s1_license";
                            $query_rpms1 = sqlsrv_query($conn, $sql_rpms1);
                            $result_rpms1 = sqlsrv_fetch_array($query_rpms1, SQLSRV_FETCH_ASSOC);
                        ?>
                        <tr>
                            <?php if($AREA=='AMT'){ ?>
                                <th class="border" width="30px" style="text-align: center;"><font size="1px">S1</font></th>
                            <?php }else if($AREA=='GW'){ ?>
                                <th class="border" width="30px" style="text-align: center;"><font size="1px">G1</font></th>
                            <?php } ?>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px">REPAIRMAN</font></th>
                            <th class="border" width="30px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s1_total"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s1_ready"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s1_leave"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s1_training"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s1_license"];?></font></th>
                        </tr>
                        <?php                                                                                    
                            $sql_rpms1 = "SELECT DISTINCT 
                            (SELECT SUM(ISNULL(CAST(total AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(1,2,4,6) AND area = '$AREA' AND total >= '0') AS s2_total,
                            (SELECT SUM(ISNULL(CAST(ready AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(1,2,4,6) AND area = '$AREA' AND ready >= '0') AS s2_ready,
                            (SELECT SUM(ISNULL(CAST(leave AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(1,2,4,6) AND area = '$AREA' AND leave >= '0') AS s2_leave,
                            (SELECT SUM(ISNULL(CAST(training AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(1,2,4,6) AND area = '$AREA' AND training >= '0') AS s2_training,
                            (SELECT SUM(ISNULL(CAST(license AS DECIMAL(6,0)),0)) FROM NCHECKMAN WHERE CONVERT ( VARCHAR ( 10 ), datework, 20 ) = '$startymd' AND refgroupid IN(1,2,4,6) AND area = '$AREA' AND license >= '0') AS s2_license";
                            $query_rpms1 = sqlsrv_query($conn, $sql_rpms1);
                            $result_rpms1 = sqlsrv_fetch_array($query_rpms1, SQLSRV_FETCH_ASSOC);
                        ?>
                        <tr>
                            <?php if($AREA=='AMT'){ ?>
                                <th class="border" width="30px" style="text-align: center;"><font size="1px">S2</font></th>
                            <?php }else if($AREA=='GW'){ ?>
                                <th class="border" width="30px" style="text-align: center;"><font size="1px">G2</font></th>
                            <?php } ?>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px">REPAIRMAN</font></th>
                            <th class="border" width="30px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s2_total"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s2_ready"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s2_leave"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s2_training"];?></font></th>
                            <th class="border" width="70px" style="text-align: center;"><font size="1px"><?=$result_rpms1["s2_license"];?></font></th>
                        </tr>
                    </tbody>
                </table>
                <br> -->
                ...
                <table class="border" style="width: 100%;">
                    <thead>
                        <!-- <tr>
                            <th class="border" colspan="109" style="text-align: center;">S1</th>
                        </tr> -->
                        <tr>
                            <th class="border" width="2%" rowspan="2" style="text-align: center;">ที่</th>
                            <th class="border" width="5%" rowspan="2" style="text-align: center;">ทะเบียน(หัว)/ชื่อรถ</th>
                            <th class="border" width="5%" rowspan="2" style="text-align: center;">ทะเบียน(หาง)</th>
                            <th class="border" width="5%" rowspan="2" style="text-align: center;">สายงาน</th>
                            <th class="border" width="6%" rowspan="2" style="text-align: center;">ลักษณะงานซ่อม</th>
                            <th class="border" width="7%" rowspan="2" style="text-align: center;">รายละเอียด</th>
                            <th class="border" width="6%" rowspan="2" style="text-align: center;">ช่างผู้ขับรถเข้าซ่อม/เลขใบขับขี่</th>
                            <th class="border" width="3%" rowspan="2" style="text-align: center;">ช่องซ่อม</th>
                            <th class="border" width="3%" rowspan="2" style="text-align: center;">จำนวนช่าง</th>
                            <th class="border" width="7%" rowspan="2" style="text-align: center;">ผู้รับผิดชอบ</th>
                            <th class="border" width="7%" rowspan="2" style="text-align: center;">ผู้ตรวจสอบ/SA</th>
                            <th class="border" width="3%" rowspan="2" style="text-align: center;">ชั่วโมงทำงาน</th>
                            <th class="border" style="text-align: center;width: 25%" colspan="96">เวลาในการปฎิบัติงาน</th>
                            <th class="border" width="3%" rowspan="2" style="text-align: center;">รวมชั่วโมง</th>
                        </tr>
                        <tr>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">0</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">1</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">2</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">3</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">4</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">5</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">6</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">7</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">8</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">9</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">10</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">11</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">12</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">13</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">14</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">15</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">16</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">17</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">18</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">19</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">20</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">21</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">22</th>
                            <th class="border" style="text-align: center;" colspan="4" width="1%">23</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        // #################################################### HEADS1 ####################################################
                            ...
                            $sql_seS1 = "SELECT 
                                ...
                                WHERE b.RPC_INCARDATE = '$txt_daterepair' AND a.RPRQ_STATUS = 'Y'
                                AND SUBSTRING(b.RPC_AREA,1,2)='S1' AND (a.RPRQ_REGISHEAD != '' OR a.RPRQ_REGISTAIL != '')  AND a.RPRQ_AREA='$AREA'
                                GROUP BY a.RPRQ_REQUESTBY_SQ,a.RPRQ_ID,a.RPRQ_CODE,a.RPRQ_REGISHEAD,a.RPRQ_CARNAMEHEAD,a.RPRQ_REGISTAIL,a.RPRQ_CARNAMETAIL,a.RPRQ_LINEOFWORK,a.RPRQ_COMPANYCASH,b.RPC_AREA,b.RPC_SUBJECT,a.RPRQ_STATUSREQUEST";
                            $params_seS1 = array();
                        ...
                        // #################################################### ACTUALS1 ####################################################
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 00:00',103))
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 00:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 00:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 00:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 01:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 01:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 01:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 01:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 02:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 02:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 02:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 02:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 03:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 03:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 03:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 03:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 04:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 04:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 04:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 04:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 05:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 05:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 05:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 05:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 06:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 06:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 06:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 06:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 07:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 07:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 07:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 07:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 08:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 08:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 08:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 08:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 09:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 09:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 09:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 09:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 10:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 10:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 10:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 10:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 11:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 11:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 11:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 11:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 12:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 12:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 12:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 12:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 13:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 13:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 13:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 13:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 14:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 14:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 14:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 14:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 15:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 15:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 15:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 15:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 16:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 16:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 16:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 16:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 17:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 17:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 17:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 17:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 18:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 18:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 18:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 18:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 19:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 19:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 19:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 19:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 20:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 21:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 21:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 21:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 21:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 22:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 22:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 22:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 22:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 23:00',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 23:15',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 23:30',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                                ...
                                AND ((SELECT MAX(RPATTM_PROCESS) FROM	dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') IS NULL OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, CONVERT(VARCHAR(10),CONVERT(DATE,GETDATE()), 103) + ' 23:45',103))
                                AND b.[RPRQ_CODE] = '".$result_seS1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seS1['RPC_SUBJECT']."'";
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;" rowspan="2"><?= $result_seS1['TECHNICIANEMPLOYEE'] ?></td>
                ...
                <table class="border" style="width: 100%;">
                    <thead>
                        <!-- <tr>
                            <th class="border" colspan="70" style="text-align: center;">S2</th>
                        </tr> -->
                        <tr>
                            <th class="border" width="2%" rowspan="2" style="text-align: center;">ที่</th>
                            <th class="border" width="5%" rowspan="2" style="text-align: center;">ทะเบียน(หัว)/ชื่อรถ</th>
                ...
                <table class="border"  border="1" style="width: 100%;">
                    <thead>
                        <tr>
                            <th class="border" colspan="2" rowspan="2" style="text-align: center;width: 10%">จำนวนช่าง</th>
                            <th class="border" colspan="2" rowspan="2" style="text-align: center;width: 10%">ชั่วโมง</th>
                            <th class="border" colspan="2" rowspan="2" style="text-align: center;width: 10%">รวมชั่วโมง</th>
                            <th class="border" colspan="2" rowspan="2" style="text-align: center;width: 10%">จำนวนคัน</th>
                            <th class="border" colspan="2" rowspan="2" style="text-align: center;width: 10%">จำนวน JOB</th>
                            <th class="border" colspan="3" rowspan="2" style="text-align: center;width: 20%">งานนอกเหนือแผน</th>
                            <th class="border" colspan="10" style="text-align: center;width: 40%">สรุป</th>
                        </tr>
                        <tr>
                            <th class="border" colspan="2" style="text-align: center;">ช่าง</th>
                            <th class="border" colspan="2" style="text-align: center;">ชั่วโมง</th>
                            <th class="border" colspan="2" style="text-align: center;">จำนวนคัน</th>
                            <th class="border" colspan="2" style="text-align: center;">จำนวน JOB</th>
                        </tr>
                        <tr>
                            <th class="border" style="text-align: center;">แผน</th>
                            <th class="border" style="text-align: center;">ผล</th>
                            <th class="border" style="text-align: center;">แผน</th>
                            <th class="border" style="text-align: center;">ผล</th>
                            <th class="border" style="text-align: center;">แผน</th>
                            <th class="border" style="text-align: center;">ผล</th>
                            ...
                            <th class="border" style="text-align: center;">แผน</th>
                            <th class="border" style="text-align: center;">ผล</th>
                            <th class="border" style="text-align: center;">ชั่วโมง</th>
                            <th class="border" style="text-align: center;">คัน</th>
                            <th class="border" style="text-align: center;">JOB</th>
                            <th class="border" style="text-align: center;">แผน</th>
                            <th class="border" style="text-align: center;">ผล</th>
                            <th class="border" style="text-align: center;">แผน</th>
                            <th class="border" style="text-align: center;">ผล</th>
