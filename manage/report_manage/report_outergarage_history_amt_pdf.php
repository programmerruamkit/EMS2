...
$tablehead =    "<thead>
                    ...
                    <tr height='30'>
                        ...
                        <th rowspan='2' width='16%' style='text-align:center;background-color: #dedede'>หมายเหตุ</th>
                    </tr>
                    <tr height='30'>
...
$tablebody =    "<tbody>";     					   		
                    ...
                    if($dt!=''){
                        $rsdt="RepairMethod LIKE '%$dt%' AND";
                    }else{$rsdt="";}
                    $wh=$rsrg.$rsse.$rspr.$rsca.$rscu.$rsdt;
                    if($wh==''){
                    ...
                    while($result_reporthdms = sqlsrv_fetch_array($query_reporthdms, SQLSRV_FETCH_ASSOC)){	
                        ...
                        $repairdate_formatted = formatDate($temp_repairdate);
                        $completedate_formatted = formatDate($temp_completedate);
                        
                        // จัดรูปแบบราคา
                        $repairprice_formatted = ($temp_repairprice > 0) ? number_format($temp_repairprice, 2) : '';
                        
$tablebody .=   "<tr height='25px'>
                    <td align='center'>".$no."</td>
                    <td align='center'>".$temp_truck."</td>
                    <td align='center'>".$temp_section."</td>
                    <td align='center'>".$repairdate_formatted."</td>
                    <td align='center'>".$completedate_formatted."</td>
                    <td align='left'>".$temp_problems."</td>
                    <td align='left'>".$temp_cause."</td>
                    <td align='left'>".$temp_repairmethod."</td>
                    <td align='center'>".$temp_garage."</td>
                    <td align='right'>".$repairprice_formatted."</td>
                    <td align='left'>".$temp_remark."</td>
                </tr>";
                }; 
