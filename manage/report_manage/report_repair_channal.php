<?php
	...
	if($SESSION_AREA=="AMT"){
		$HREF="../manage/report_manage/report_repair_channal_amt_excel.php?txt_datestart='+datestartdetail+'&area=$SESSION_AREA";
	}else{
		$HREF="../manage/report_manage/report_repair_channal_gw_excel.php?txt_datestart='+datestartdetail+'&area=$SESSION_AREA";
	}
	$getday = $GETDAYEN;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="INVENDATA no-border">
  <tr class="TOP">
    ...
    <td class="CENTER"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="419" height="10%" valign="bottom" class=""><h3>&nbsp;&nbsp;รายงานประสิทธิภาพช่องซ่อม (<?=$SESSION_AREA?>)</h3></td>
            ...
            <tr align="center">
              <td width="10%" align="right"><strong>เงื่อนไขการค้นหา :</strong></td>    
                <td width="20%" align="left">
                  <div class="row input-control">เลือกวันที่
                ...
                <td width="30%" align="center">
                  <div class="row input-control"><br>
                    <button  title="Excel" type="button" class="bg-color-green big" onclick="excel_estimatecashdaily_plan()"><font color="white" size="4"><i class="icon-file-excel icon-large"></i> Excel รายงานประสิทธิภาพช่องซ่อม</font></button>
                  </div>
                </td>
                <td align="center"></td>
            </tr>
  ...
  <tr class="BOTTOM">
    ...
    <td class="CENTER">&nbsp;		
      <center>
        <input type="button" class="button_gray" value="อัพเดท" onClick="javascript:loadViewdetail('<?=$path?>manage/report_manage/report_repair_channal.php');">
      </center>
    </td>
    <td class="RIGHT">&nbsp;</td>
  </tr>
