            ...
            <div id="datadef">
                ...
                <table style="width: 100%;">
                    <thead>
                        <tr>
                            <?php if($AREA=='AMT'){ ?>
                                <th style="text-align: left;"><b>แผนการทำงาน บริษัท ร่วมกิจรุ่งเรือง ทรัค ดีเทลส์ จำกัด พื้นที่อมตะ G1,G2</b></th>
                            <?php }else if($AREA=='GW'){ ?>
                    ...
                    <tbody>
                        ...
                        // #################################################### HEADG1 ####################################################
                            ...
                            while ($result_seG1 = sqlsrv_fetch_array($query_seG1, SQLSRV_FETCH_ASSOC)) {
                                ...
                                $sql_seActG1 = "SELECT RPATTM_GROUP FROM [dbo].[REPAIRACTUAL_TIME] WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG1['RPC_SUBJECT']."' ORDER BY RPATTM_PROCESS DESC";
                        ...
                        // #################################################### PLANG1 ####################################################
                                ...
                                AND b.RPC_REMARK IS NULL AND b.[RPRQ_CODE] = '".$result_seG1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seG1['RPC_SUBJECT']."'";
                        ...
                        // #################################################### ACTUALG1 ####################################################
                                ...
                                AND b.[RPRQ_CODE] = '".$result_seG1['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seG1['RPC_SUBJECT']."'";
