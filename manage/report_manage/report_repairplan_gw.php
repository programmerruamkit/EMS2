<?php
    ...
    // $strExcelFileName = "รายละเอียดข้อมูลแผนงานซ่อม(".$SESSION_AREA.")" . $txt_daterepair . ' ถึง ' . $txt_dateend_amt . ".xls";
    ...
    for ($h = 0; $h < 24; $h++) {
        for ($m = 0; $m < 60; $m += 15) {
            $time_intervals[] = sprintf('%02d:%02d', $h, $m);
        }
    }
    $result_counts_s1 = [];
    $result_counts_s2 = [];
        ...
        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                    ...
                    <thead>
                        <tr>
                            <th style="text-align: left;">
                                <b>แผนการทำงาน บริษัท ร่วมกิจรุ่งเรือง ทรัค ดีเทลส์ จำกัด พื้นที่ G1, G2</b>
                            </th>
                        </tr>
                        <tr>
                            <th style="text-align: left;"><b>ประจำวันที่ <?=$startymdth;?></b></th>
                        </tr>
                    </thead>
                </table>
                <!-- <br> -->
            <!-- G1 ############################################################################################################################## -->
                <?php
                    ...
                    AND SUBSTRING(b.RPC_AREA,1,2)='G1' AND (a.RPRQ_REGISHEAD != '' OR a.RPRQ_REGISTAIL != '')  AND a.RPRQ_AREA='$AREA'";
                ...
                <table class="border" border="1" style="width: 100%;">
                    <thead>
                        <!-- <tr>
                            <th class="border" border="1" colspan="109" style="text-align: center;">G1</th>
                        </tr> -->
                        <tr>
                        ...
                        <tr>
                            <?php for ($ith1 = 0; $ith1 <= 23; $ith1++): ?>
                                <th class="border" style="text-align: center;" colspan="4" width="1%"><?=$ith1?></th>
                            <?php endfor; ?>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        // #################################################### HEADG1 ####################################################
                            ...
                            $sql_seG1 = "SELECT 
                                ...
                                'G1/'+SUBSTRING(b.RPC_AREA,4,1) AS CH,
                                CASE
                                ...
                                WHERE b.RPC_INCARDATE = '$txt_daterepair' AND a.RPRQ_STATUS = 'Y'
                                AND SUBSTRING(b.RPC_AREA,1,2)='G1' AND (a.RPRQ_REGISHEAD != '' OR a.RPRQ_REGISTAIL != '')  AND a.RPRQ_AREA='$AREA' AND NOT a.RPRQ_STATUSREQUEST = 'รอจ่ายงาน'
                            ...
                            $params_seG1 = array();
                            $query_seG1 = sqlsrv_query($conn, $sql_seG1, $params_seG1);
                            while ($result_seG1 = sqlsrv_fetch_array($query_seG1, SQLSRV_FETCH_ASSOC)) {
                                if ($result_seG1['CUSTOMER'] == '' ) {
                                    $customercode1 = $result_seG1['COMPANYPAYMENT'];
                                }else {
                                    $customercode1 = $result_seG1['CUSTOMER'];
                                }

                                $sql_seEmpG1 = "SELECT COUNT(*) AS CNT FROM [dbo].[REPAIRMANEMP] WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG1['RPC_SUBJECT']."'";
                                $params_seEmpG1 = array();
                                $query_seEmpG1 = sqlsrv_query($conn, $sql_seEmpG1, $params_seEmpG1);
                                $result_seEmpG1 = sqlsrv_fetch_array($query_seEmpG1, SQLSRV_FETCH_ASSOC);

                                $sql_seCauG1 = "SELECT RPC_DETAIL DETAIL FROM [dbo].[REPAIRCAUSE] WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG1['RPC_SUBJECT']."'";
                                $params_seCauG1 = array();
                                $query_seCauG1 = sqlsrv_query($conn, $sql_seCauG1, $params_seCauG1);
                                $result_seCauG1 = sqlsrv_fetch_array($query_seCauG1, SQLSRV_FETCH_ASSOC);
                                
                                $sql_seActG1 = "SELECT TOP 1 RPATTM_GROUP FROM [dbo].[REPAIRACTUAL_TIME] WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG1['RPC_SUBJECT']."' ORDER BY RPATTM_PROCESS DESC";
                                $params_seActG1 = array();
                                $query_seActG1 = sqlsrv_query($conn, $sql_seActG1, $params_seActG1);
                                $result_seActG1 = sqlsrv_fetch_array($query_seActG1, SQLSRV_FETCH_ASSOC);
                                ...
                                $sql_seHourG1 = "SELECT 
                                    ...
                                    FROM [dbo].[REPAIRCAUSE] WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG1['RPC_SUBJECT']."' AND (RPC_REMARK = '' OR RPC_REMARK IS NULL)";
                                $params_seHourG1 = array();
                                $query_seHourG1 = sqlsrv_query($conn, $sql_seHourG1, $params_seHourG1);
                                $result_seHourG1 = sqlsrv_fetch_array($query_seHourG1, SQLSRV_FETCH_ASSOC);

                                $remains1 = intval(strtotime($result_seHourG1['COMPLETEDDATE']) - strtotime($result_seHourG1['CARINPUTDATE']));
                                ...
                                // echo $result_seG1['RPRQ_CODE']."<br>";
                                // echo $result_seG1['RPC_SUBJECT']."<br>";
                                // echo $result_seHourG1['CARINPUTDATE']."<br>";
                                // echo $result_seHourG1['COMPLETEDDATE']."<br>";
                                // echo "ผ่านมาแล้ว ".$wans1." วัน ".$hours1." ชั่วโมง ".$minutes1." นาที ".$seconds1." วินาที"."<br>";
                                // echo $result_seActG1['RPATTM_GROUP']."<br>";
                                
                                if ($result_seActG1['RPATTM_GROUP'] == 'SUCCESS') {                                    
                                    $sql_seHouracG1 = "SELECT DISTINCT A.RPRQ_CODE,A.RPC_SUBJECT,
                                        ...
                                        FROM REPAIRACTUAL_TIME A WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG1['RPC_SUBJECT']."'";
                                    $params_seHouracG1 = array();
                                    $query_seHouracG1 = sqlsrv_query($conn, $sql_seHouracG1, $params_seHouracG1);
                                    $result_seHouracG1 = sqlsrv_fetch_array($query_seHouracG1, SQLSRV_FETCH_ASSOC);
                                    
                                    $remainacs1 = intval(strtotime($result_seHouracG1['CLOSEDATE']) - strtotime($result_seHouracG1['OPENDATE']));
                                    ...
                                    $sql_seHouracG1 = "SELECT A.RPRQ_CODE,A.RPC_SUBJECT,
                                        (SELECT MIN(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME	WHERE RPRQ_CODE=A.RPRQ_CODE AND RPC_SUBJECT = A.RPC_SUBJECT AND RPATTM_GROUP = 'START') AS 'OPENDATE',
                                ...
                                $cntemps1 += $result_seEmpG1['CNT'];

                                $dateinput = $txt_daterepair;

                                $DETAIL1=$result_seCauG1['DETAIL'];
                                ...
                                if($DETAILX10=="PM"){
                                    $sql_chketmrpmdrive1 = "SELECT * FROM REPAIRMANDRIVE WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."' AND RPMD_ZONE = 'G1'";
                                }else{
                                    $sql_chketmrpmdrive1 = "SELECT * FROM REPAIRMANDRIVE WHERE RPRQ_CODE='".$result_seG1['RPRQ_CODE']."'";
                                }
                                ...
                                if($DETAILX10=="PM"){
                                    $TECHNICIANEMPLOYEES1 = $result_seG1['NAMEASSIGN'];
                                }else {
                                    $TECHNICIANEMPLOYEES1 = $result_seG1['RPRQ_REQUESTBY_SQ'];
                                }
                        // #################################################### PLANG1 ####################################################
                            $sql_zone1P = "SELECT COUNT(*) AS CNT FROM [dbo].[REPAIRCAUSE] b
                                            WHERE CONVERT(DATETIME, ?, 103) 
                                            BETWEEN CONVERT(CHAR(19), CONVERT(DATETIME, RPC_INCARDATE+' '+RPC_INCARTIME, 103), 120)
                                            AND CONVERT(CHAR(19), CONVERT(DATETIME, RPC_OUTCARDATE+' '+RPC_OUTCARTIME, 103), 120)
                                            AND b.RPC_REMARK IS NULL 
                                            AND b.[RPRQ_CODE] = ? 
                                            AND b.[RPC_SUBJECT] = ?";
                            
                            $stmt_zone1P = sqlsrv_prepare($conn, $sql_zone1P, array(&$datetime, &$rprq_code, &$rpc_subject));
                            
                            foreach ($time_intervals as $time) {
                                $datetime = $dateinput . ' ' . $time;
                                $rprq_code = $result_seG1['RPRQ_CODE'];
                                $rpc_subject = $result_seG1['RPC_SUBJECT'];
                            
                                if (sqlsrv_execute($stmt_zone1P)) {
                                    $row = sqlsrv_fetch_array($stmt_zone1P, SQLSRV_FETCH_ASSOC);
                                    $result_counts_s1[$time] = $row['CNT'];
                                    
                                    // กำหนดสีพื้นหลัง
                                    $styles_s1P[$time] = ($row['CNT'] != '0') ? "background-color: yellow" : "";
                                } else {
                                    $result_counts_s1[$time] = 0;
                                    $styles_s1P[$time] = "";
                                }
                            }
                        // #################################################### ACTUALG1 ####################################################    
                                foreach ($time_intervals as $time) {
                                    $sql_zone1A = "SELECT COUNT(*) AS CNT FROM [dbo].[REPAIRACTUAL_TIME] b
                                            WHERE CONVERT(DATETIME, '".$dateinput." $time', 103) 
                                            BETWEEN DATEADD(MINUTE,-16,(SELECT MIN(RPATTM_PROCESS) 
                                            FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE 
                                            AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'START')) 
                                            AND CONVERT(DATETIME, GETDATE(), 103)
                                            AND ((SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME 
                                            WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT 
                                            AND RPATTM_GROUP = 'SUCCESS') IS NULL 
                                            OR (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME 
                                            WHERE RPRQ_CODE = b.RPRQ_CODE AND RPC_SUBJECT = b.RPC_SUBJECT 
                                            AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, '".$dateinput." $time', 103))
                                            AND b.[RPRQ_CODE] = '".$result_seG1['RPRQ_CODE']."'
                                            AND b.[RPC_SUBJECT] = '".$result_seG1['RPC_SUBJECT']."'";
                                    $query_zone1A = sqlsrv_query($conn, $sql_zone1A);
                                    if ($query_zone1A === false) {
                                        die(print_r(sqlsrv_errors(), true)); // เช็ค error SQL
                                    }
                    
                                    $result_zone1A = sqlsrv_fetch_array($query_zone1A, SQLSRV_FETCH_ASSOC);
                            
                                    if ($result_zone1A['CNT'] != '0') {
                                        if ($result_seActG1['RPATTM_GROUP'] == 'SUCCESS') {
                                            $styles_s1A[$time] = "background-color: green";
                                        } elseif ($result_seActG1['RPATTM_GROUP'] == 'PAUSE') {
                                            $styles_s1A[$time] = "background-color: white";
                                        } else {
                                            $styles_s1A[$time] = "background-color: blue";
                                        }
                                    } else {
                                        $styles_s1A[$time] = "";
                                    }
                                ...
                                if ($result_seG1['VEHICLEREGISNUMBER1'] != '') {
                                    $VEHICLEREGISNUMBERG11 = $result_seG1['VEHICLEREGISNUMBER1'] . '(1)';
                                } else {
                                    $VEHICLEREGISNUMBERG11 = '';
                                }
                                if ($result_seG1['VEHICLEREGISNUMBER2'] != '') {
                                    $VEHICLEREGISNUMBERG12 = $result_seG1['VEHICLEREGISNUMBER2'] . '(2)';
                                } else {
                                    $VEHICLEREGISNUMBERG12 = '';
                                }

                                if ($result_seG1['VEHICLEREGISNUMBER1'] == '' || $result_seG1['VEHICLEREGISNUMBER2'] == '') {
                                    $commas1 = '';
                                } else {
                                    $commas1 = ',';
                                }
                        ?>
                        <tr>
                            <td style="text-align: center;" rowspan="2"><?= $iG1 ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $result_seG1['VEHICLEREGISNUMBER1']?><?php if($result_seG1['THAINAME1']!=''){echo '/';}?> <?= $result_seG1['THAINAME1'] ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $result_seG1['VEHICLEREGISNUMBER2'] ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $customercode1 ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $result_seG1['SUBJECT'] ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $result_seCauG1['DETAIL'] ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $rsdrivename1 ?> <?php if($rsdrivename1!=''){echo '/';}?> <?= $rsdrivecard1 ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $result_seG1['CH'] ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $result_seEmpG1['CNT'] ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $result_seG1['REPAIRMAN'] ?></td>
                            <td style="text-align: center;" rowspan="2"><?= $TECHNICIANEMPLOYEES1 ?></td>
                            <td style="text-align: center;">แผน</td>
                            <?php foreach ($time_intervals as $time): ?>
                                <td width="0%" style="text-align: center; <?= $styles_s1P[$time] ?>"></td>
                            <?php endforeach; ?>
                        ...
                        <tr>
                            ...
                            <?php foreach ($time_intervals as $time): ?>
                                <td style="text-align: center; <?= isset($styles_s1A[$time]) ? $styles_s1A[$time] : '' ?>"></td>
                            <?php endforeach; ?>
                            <?php if ($result_seHouracG1['OPENDATE'] == '') { ?>
            ...
            <!-- G2 ############################################################################################################################## -->
                <?php
                    ...
                    INNER JOIN [dbo].[REPAIRCAUSE] b ON a.RPRQ_CODE=b.RPRQ_CODE
                    WHERE b.RPC_INCARDATE = '$txt_daterepair' AND a.RPRQ_STATUS = 'Y'
                    AND SUBSTRING(b.RPC_AREA,1,2)='G2' AND (a.RPRQ_REGISHEAD != '' OR a.RPRQ_REGISTAIL != '')  AND a.RPRQ_AREA='$AREA'";
                ...
                <table class="border" border="1" style="width: 100%;">
                    <thead>
                        <!-- <tr>
                            <th class="border" border="1" colspan="70" style="text-align: center;">G2</th>
                        </tr> -->
                        <tr>
                            <th class="border" border="1" width="2%" rowspan="2" style="text-align: center;">ที่</th>
                            <th class="border" border="1" width="5%" rowspan="2" style="text-align: center;">ทะเบียน(หัว)/ชื่อรถ</th>
                        ...
                        <tr>
                            <?php for ($ith2 = 0; $ith2 <= 23; $ith2++): ?>
                                <th class="border" style="text-align: center;" colspan="4" width="1%"><?=$ith2?></th>
                            <?php endfor; ?>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        // #################################################### HEADG2 ####################################################
                            ...
                            $sql_seG2 = "SELECT 
                                ...
                                a.RPRQ_LINEOFWORK CUSTOMER,
                                a.RPRQ_COMPANYCASH COMPANYPAYMENT,
                                'G2/'+SUBSTRING(b.RPC_AREA,4,1) AS CH,
                                CASE
                                    WHEN b.RPC_SUBJECT = 'EL' THEN 'ระบบไฟ'
                                    WHEN b.RPC_SUBJECT = 'TU' THEN 'ยาง ช่วงล่าง'
                                    WHEN b.RPC_SUBJECT = 'BD' THEN 'โครงสร้าง'
                                ...
                                LEFT JOIN vwEMPLOYEE c ON c.PersonCode = a.RPRQ_ASSIGN_BY
                                WHERE b.RPC_INCARDATE = '$txt_daterepair' AND a.RPRQ_STATUS = 'Y'
                                AND SUBSTRING(b.RPC_AREA,1,2)='G2' AND (a.RPRQ_REGISHEAD != '' OR a.RPRQ_REGISTAIL != '')  AND a.RPRQ_AREA='$AREA' AND NOT a.RPRQ_STATUSREQUEST = 'รอจ่ายงาน'
                                GROUP BY a.RPRQ_ASSIGN_BY,c.nameT,a.RPRQ_REQUESTBY_SQ,a.RPRQ_ID,a.RPRQ_CODE,a.RPRQ_REGISHEAD,a.RPRQ_CARNAMEHEAD,a.RPRQ_REGISTAIL,a.RPRQ_CARNAMETAIL,a.RPRQ_LINEOFWORK,a.RPRQ_COMPANYCASH,b.RPC_AREA,b.RPC_SUBJECT,a.RPRQ_STATUSREQUEST";
                            $params_seG2 = array();
                            $query_seG2 = sqlsrv_query($conn, $sql_seG2, $params_seG2);
                            while ($result_seG2 = sqlsrv_fetch_array($query_seG2, SQLSRV_FETCH_ASSOC)) {
                                if ($result_seG2['CUSTOMER'] == '' ) {
                                    $customercode2 = $result_seG2['COMPANYPAYMENT'];
                                }else {
                                    $customercode2 = $result_seG2['CUSTOMER'];
                                }

                                $sql_seEmpG2 = "SELECT COUNT(*) AS CNT FROM [dbo].[REPAIRMANEMP] WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG2['RPC_SUBJECT']."'";
                                $params_seEmpG2 = array();
                                $query_seEmpG2 = sqlsrv_query($conn, $sql_seEmpG2, $params_seEmpG2);
                                $result_seEmpG2 = sqlsrv_fetch_array($query_seEmpG2, SQLSRV_FETCH_ASSOC);

                                $sql_seCauG2 = "SELECT RPC_DETAIL DETAIL FROM [dbo].[REPAIRCAUSE] WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG2['RPC_SUBJECT']."'";
                                $params_seCauG2 = array();
                                $query_seCauG2 = sqlsrv_query($conn, $sql_seCauG2, $params_seEmpG2);
                                $result_seCauG2 = sqlsrv_fetch_array($query_seCauG2, SQLSRV_FETCH_ASSOC);

                                $sql_seActG2 = "SELECT RPATTM_GROUP FROM [dbo].[REPAIRACTUAL_TIME] WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG2['RPC_SUBJECT']."' ORDER BY RPATTM_PROCESS DESC";
                                $params_seActG2 = array();
                                $query_seActG2 = sqlsrv_query($conn, $sql_seActG2, $params_seActG2);
                                $result_seActG2 = sqlsrv_fetch_array($query_seActG2, SQLSRV_FETCH_ASSOC);

                                $sql_seHourG2 = "SELECT 
                                    CONVERT(CHAR(19), CONVERT(DATETIME, RPC_INCARDATE+' '+RPC_INCARTIME, 103), 120) AS 'CARINPUTDATE',
                                    CONVERT(CHAR(19), CONVERT(DATETIME, RPC_OUTCARDATE+' '+RPC_OUTCARTIME, 103), 120) AS 'COMPLETEDDATE'
                                    FROM [dbo].[REPAIRCAUSE] WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG2['RPC_SUBJECT']."' AND (RPC_REMARK = '' OR RPC_REMARK IS NULL)";
                                $params_seHourG2 = array();
                                $query_seHourG2 = sqlsrv_query($conn, $sql_seHourG2, $params_seHourG2);
                                $result_seHourG2 = sqlsrv_fetch_array($query_seHourG2, SQLSRV_FETCH_ASSOC);

                                $remains2 = intval(strtotime($result_seHourG2['COMPLETEDDATE']) - strtotime($result_seHourG2['CARINPUTDATE']));
                                ...
                                // echo $result_seG2['RPRQ_CODE']."<br>";
                                // echo $result_seG2['RPC_SUBJECT']."<br>";
                                // echo $result_seHourG2['CARINPUTDATE']."<br>";
                                // echo $result_seHourG2['COMPLETEDDATE']."<br>";
                                // echo "ผ่านมาแล้ว ".$wan." วัน ".$hour." ชั่วโมง ".$minute." นาที ".$second." วินาที";

                                if ($result_seActG2['RPATTM_GROUP'] == 'SUCCESS') {
                                    $sql_seHouracG2 = "SELECT DISTINCT A.RPRQ_CODE,A.RPC_SUBJECT,
                                        (SELECT MIN(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME	WHERE RPRQ_CODE=A.RPRQ_CODE AND RPC_SUBJECT = A.RPC_SUBJECT AND RPATTM_GROUP = 'START') AS 'OPENDATE',
                                        (SELECT MAX(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE=A.RPRQ_CODE AND RPC_SUBJECT = A.RPC_SUBJECT AND RPATTM_GROUP = 'SUCCESS') AS 'CLOSEDATE'
                                        FROM REPAIRACTUAL_TIME A WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG2['RPC_SUBJECT']."'";
                                    $params_seHouracG2 = array();
                                    $query_seHouracG2 = sqlsrv_query($conn, $sql_seHouracG2, $params_seHouracG2);
                                    $result_seHouracG2 = sqlsrv_fetch_array($query_seHouracG2, SQLSRV_FETCH_ASSOC);
                                
                                    $remainacs2 = intval(strtotime($result_seHouracG2['CLOSEDATE']) - strtotime($result_seHouracG2['OPENDATE']));
                                    ...
                                    $sql_seHouracG2 = "SELECT A.RPRQ_CODE,A.RPC_SUBJECT,
                                        (SELECT MIN(RPATTM_PROCESS) FROM dbo.REPAIRACTUAL_TIME	WHERE RPRQ_CODE=A.RPRQ_CODE AND RPC_SUBJECT = A.RPC_SUBJECT AND RPATTM_GROUP = 'START') AS 'OPENDATE',
                                        CONVERT(VARCHAR(10), GETDATE(), 121) + ' '  + CONVERT(VARCHAR(5), GETDATE(), 14) AS 'CLOSEDATE' 
                                        FROM REPAIRACTUAL_TIME A WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."' AND RPC_SUBJECT='".$result_seG2['RPC_SUBJECT']."'";
                                    $params_seHouracG2 = array();
                                ...
                                $cntemps2 += $result_seEmpG2['CNT'];

                                $dateinput = $txt_daterepair;

                                $DETAIL2=$result_seCauG2['DETAIL'];
                                ...
                                if($DETAILX20=="PM"){
                                    $sql_chketmrpmdrive2 = "SELECT * FROM REPAIRMANDRIVE WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."' AND RPMD_ZONE = 'G2'";
                                }else{
                                    $sql_chketmrpmdrive2 = "SELECT * FROM REPAIRMANDRIVE WHERE RPRQ_CODE='".$result_seG2['RPRQ_CODE']."'";
                                }
                                ...
                                if($DETAILX20=="PM"){
                                    ...
                                    $TECHNICIANEMPLOYEES2 = $result_seG2['RPRQ_REQUESTBY_SQ'];
                                }
                        // #################################################### PLANG2 ####################################################
                            $sql_zone2P = "SELECT COUNT(*) AS CNT FROM [dbo].[REPAIRCAUSE] b
                                            WHERE CONVERT(DATETIME, ?, 103) 
                                            BETWEEN CONVERT(CHAR(19), CONVERT(DATETIME, RPC_INCARDATE+' '+RPC_INCARTIME, 103), 120)
                                            AND CONVERT(CHAR(19), CONVERT(DATETIME, RPC_OUTCARDATE+' '+RPC_OUTCARTIME, 103), 120)
                                            AND b.RPC_REMARK IS NULL 
                            ...
                            $stmt_zone2P = sqlsrv_prepare($conn, $sql_zone2P, array(&$datetime, &$rprq_code, &$rpc_subject));
                            
                            foreach ($time_intervals as $time) {
                                $datetime = $dateinput . ' ' . $time;
                                $rprq_code = $result_seG2['RPRQ_CODE'];
                                $rpc_subject = $result_seG2['RPC_SUBJECT'];
                            
                                if (sqlsrv_execute($stmt_zone2P)) {
                                    $row = sqlsrv_fetch_array($stmt_zone2P, SQLSRV_FETCH_ASSOC);
                                    $result_counts_s2[$time] = $row['CNT'];
                                    
                                    // กำหนดสีพื้นหลัง
                                    $styles_s2P[$time] = ($row['CNT'] != '0') ? "background-color: yellow" : "";
                                } else {
                                    $result_counts_s2[$time] = 0;
                                    $styles_s2P[$time] = "";
                                }
                            }
                        // #################################################### ACTUALG2 ####################################################
                                // ตัวแปรเพื่อเก็บข้อมูลสีที่ใช้แสดง
                                $is_pause_continue = false;
                            
                                foreach ($time_intervals as $time) {
                                    // ตรวจสอบข้อมูลจากฐานข้อมูล
                                    $sql_zone2A = "SELECT COUNT(*) AS CNT 
                                                    FROM [dbo].[REPAIRACTUAL_TIME] b
                                                    WHERE CONVERT(DATETIME, '".$dateinput." $time', 103) 
                                                    BETWEEN DATEADD(MINUTE,-16,(SELECT MIN(RPATTM_PROCESS) 
                                                    FROM dbo.REPAIRACTUAL_TIME WHERE RPRQ_CODE = b.RPRQ_CODE 
                                                    AND RPC_SUBJECT = b.RPC_SUBJECT AND RPATTM_GROUP = 'START')) 
                                                    AND CONVERT(DATETIME, GETDATE(), 103)
                                                    AND ((SELECT MAX(RPATTM_PROCESS) 
                                                            FROM dbo.REPAIRACTUAL_TIME 
                                                            WHERE RPRQ_CODE = b.RPRQ_CODE 
                                                            AND RPC_SUBJECT = b.RPC_SUBJECT 
                                                            AND RPATTM_GROUP = 'SUCCESS') IS NULL 
                                                    OR (SELECT MAX(RPATTM_PROCESS) 
                                                        FROM dbo.REPAIRACTUAL_TIME 
                                                        WHERE RPRQ_CODE = b.RPRQ_CODE 
                                                        AND RPC_SUBJECT = b.RPC_SUBJECT 
                                                        AND RPATTM_GROUP = 'SUCCESS') > CONVERT(DATETIME, '".$dateinput." $time', 103))
                                                    AND b.[RPRQ_CODE] = '".$result_seG2['RPRQ_CODE']."'
                                                    AND b.[RPC_SUBJECT] = '".$result_seG2['RPC_SUBJECT']."'";
                            
                                    $query_zone2A = sqlsrv_query($conn, $sql_zone2A);
                                    $result_zone2A = sqlsrv_fetch_array($query_zone2A, SQLSRV_FETCH_ASSOC);
                            
                                    if ($result_zone2A['CNT'] != '0') {
                                        // ตรวจสอบว่าในช่วง PAUSE ถึง CONTINUE
                                        $sql_check_continue = "SELECT RPATTM_GROUP, RPATTM_PROCESS 
                                                            FROM [dbo].[REPAIRACTUAL_TIME] b
                                                            WHERE RPATTM_GROUP = 'CONTINUE'
                                                            AND b.[RPRQ_CODE] = '".$result_seG2['RPRQ_CODE']."'
                                                            AND b.[RPC_SUBJECT] = '".$result_seG2['RPC_SUBJECT']."'
                                                            AND RPATTM_PROCESS > '".$result_seActG2['RPATTM_PROCESS']."' 
                                                            AND RPATTM_PROCESS <= DATEADD(MINUTE, 16, '".$result_seActG2['RPATTM_PROCESS']."')";
                                        $query_check_continue = sqlsrv_query($conn, $sql_check_continue);
                                        $result_check_continue = sqlsrv_fetch_array($query_check_continue, SQLSRV_FETCH_ASSOC);
                            
                                        // ถ้าพบสถานะ PAUSE แล้วตามด้วย CONTINUE
                                        if ($result_seActG2['RPATTM_GROUP'] == 'PAUSE' && $result_check_continue) {
                                            // ในช่วงเวลาระหว่าง PAUSE ถึง CONTINUE จะไม่มีสีแสดง
                                            $styles_s2A[$time] = "";  
                                            $is_pause_continue = true;  // ตั้งค่าตัวแปรให้เป็น true
                                        } 
                                        // ถ้ามี CONTINUE และก่อนหน้านี้มี PAUSE ให้เริ่มแสดงสี
                                        elseif ($is_pause_continue && $result_seActG2['RPATTM_GROUP'] == 'SUCCESS') {
                                            $styles_s2A[$time] = "background-color: green";  // สีเขียวเมื่อมี SUCCESS
                                            $is_pause_continue = false; // รีเซ็ตสถานะ
                                        } 
                                        // ถ้ามี PAUSE, จะมีการแสดงสีขาว
                                        elseif ($is_pause_continue && $result_seActG2['RPATTM_GROUP'] == 'PAUSE') {
                                            $styles_s2A[$time] = "background-color: white";  // สีขาวเมื่อพบ PAUSE
                                            $is_pause_continue = false; // รีเซ็ตสถานะ
                                        } else {
                                            // ถ้าสถานะไม่ใช่ PAUSE หรือ CONTINUE
                                            if ($result_seActG2['RPATTM_GROUP'] == 'SUCCESS') {
                                                $styles_s2A[$time] = "background-color: green";  // สีเขียวเมื่อ SUCCESS
                                            } elseif ($result_seActG2['RPATTM_GROUP'] == 'PAUSE') {
                                                $styles_s2A[$time] = "background-color: white";  // สีขาวเมื่อ PAUSE
                                            } else {
                                                $styles_s2A[$time] = "background-color: blue";  // สีฟ้าเมื่อ START
                                            }
                                        }
                                    } else {
                                        // ถ้าไม่มีข้อมูลในช่วงเวลานั้นๆ
                                        $styles_s2A[$time] = "";  // ไม่มีสีแสดง
                                    }
                                }
                    

                                if ($result_seG2['VEHICLEREGISNUMBER1'] != '') {
                                    $VEHICLEREGISNUMBERG21 = $result_seG2['VEHICLEREGISNUMBER1'] . '(1)';
                                } else {
                                    $VEHICLEREGISNUMBERG21 = '';
                                }
                                if ($result_seG2['VEHICLEREGISNUMBER2'] != '') {
                                    $VEHICLEREGISNUMBERG22 = $result_seG2['VEHICLEREGISNUMBER2'] . '(2)';
                                } else {
                                    $VEHICLEREGISNUMBERG22 = '';
                                }

                                if ($result_seG2['VEHICLEREGISNUMBER1'] == '' || $result_seG2['VEHICLEREGISNUMBER2'] == '') {
                                    $commas2 = '';
                                } else {
                                    $commas2 = ',';
                                }
                    ?>
                    <tr>
                        <td style="text-align: center;" rowspan="2"><?= $iG2 ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seG2['VEHICLEREGISNUMBER1'].'/'.$result_seG2['THAINAME1'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seG2['VEHICLEREGISNUMBER2'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $customercode2 ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seG2['SUBJECT'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seCauG2['DETAIL'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $rsdrivename2 ?> <?php if($rsdrivename2!=''){echo '/';}?> <?= $rsdrivecard2 ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seG2['CH'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seEmpG2['CNT'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seG2['REPAIRMAN'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $TECHNICIANEMPLOYEES2 ?></td>
                        <td style="text-align: center;">แผน</td>
                        <?php foreach ($time_intervals as $time): ?>
                            <td width="0%" style="text-align: center; <?= $styles_s2P[$time] ?>"></td>
                        <?php endforeach; ?>
                    ...
                    <tr>
                        <td style="text-align: center;">ทำจริง</td>
                        <?php foreach ($time_intervals as $time): ?>
                            <td style="text-align: center; <?= isset($styles_s2A[$time]) ? $styles_s2A[$time] : '' ?>"></td>
                        <?php endforeach; ?>
                        <?php if ($result_seHouracG2['OPENDATE'] == '') { ?>
                        <td style="text-align: center;"></td>
                        <?php } else { ?>
            ...
            <!-- OTHER ############################################################################################################################## -->
                ...
                <table class="border" border="1" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        // #################################################### HEADG2 ####################################################
                            ...
                            $sql_seG2 = "SELECT 
                                ...
                                INNER JOIN [dbo].[REPAIRCAUSE] b ON a.RPRQ_CODE=b.RPRQ_CODE
                                WHERE b.RPC_INCARDATE = '$txt_daterepair' AND a.RPRQ_STATUS = 'Y'
                                AND b.RPC_AREA IS NULL AND (a.RPRQ_REGISHEAD != '' OR a.RPRQ_REGISTAIL != '')  AND a.RPRQ_AREA='$AREA' AND NOT a.RPRQ_STATUSREQUEST = 'รอจ่ายงาน'
                        ...
                        // #################################################### OTHER PLANG2 ####################################################
                                ...
                                AND b.RPC_REMARK IS NULL AND b.[RPRQ_CODE] = '".$result_seG2['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seG2['RPC_SUBJECT']."'";
                        ...
                        // #################################################### OTHER ACTUALG2 ####################################################
                                ...
                                AND b.[RPRQ_CODE] = '".$result_seG2['RPRQ_CODE']."' AND b.[RPC_SUBJECT]='".$result_seG2['RPC_SUBJECT']."'";
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;" rowspan="2"><?= $result_seEmpG2['CNT'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seG2['REPAIRMAN'] ?></td>
                        <td style="text-align: center;" rowspan="2"><?= $result_seG2['TECHNICIANEMPLOYEE'] ?></td>
                        <td style="text-align: center;">แผน</td>
